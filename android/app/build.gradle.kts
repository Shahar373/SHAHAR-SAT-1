...
android {
    ...
    defaultConfig {
        ...
        // BLUETOOTH_SCAN/BLUETOOTH_CONNECT (Android 12, API 31) are the
        // only BLE runtime permissions this app requests — no Location
        // permission, which is why minSdk is pinned here rather than
